...
import { LayoutGrid, ArrowLeft, Search, ChevronDown, ShoppingCart } from "lucide-react";
...
export default function Products() {
  ...
  useEffect(() => {
    document.title = "Our Custom Products — Sun Star Packers";
  }, []);
  ...
  useEffect(() => {
    setSelectedMaterial(materialParam || "All");
  }, [materialParam]);
  ...
  const handleAddToWishlistCart = (product) => {
    try {
      ...
      if (existingIndex > -1) {
        ...
        const numericPrice = parseInt(product.price?.toString().replace(/[^\d]/g, "") || "50") || 50;
        currentCart.push({
          id: product.id,
          name: product.name,
          price: numericPrice,
